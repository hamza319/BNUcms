...
<html>
    <head>
        <title>Recieved Complaints</title>
        <meta charset="UTF-8">
    ...
    <div id="menuMain">
        ...
        <ul>
            ...
            <li class="student"><a href="#">Received</a></li>
        </ul>
        </div>
       </div> 
        ...
        <div class="container">
            <div class="main" style="text-align: center">
                <strong style='font-size: 20px'>Recieved Complaints</strong>
                    ...
                    <div class="col-md-10">
                        <table class="table table-hover" style="text-align: left">
                            ...
                            <?php
                                ...
                                for($i=0; $i<$mailbox->getRecievedSize();$i++){
                                
                                    $cr = $mailbox->getRecieved($i);
                                    
                                    echo "<tr class='item ".$cr->getType()."' id='".$cr->getID()."' data-href='Complaint.php?thing=".$cr->getID()."&From=rec'>";
                                    echo "<td>".$cr->getID()."</td>";
                                    echo "<td>".$cr->getSubject()."</td>";
                                    echo "<td>".$cr->getRoll()."</td>";
