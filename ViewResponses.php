 ...
 <div id="menuMain">
        ...
        <div class="container">
            <div class="main" style="text-align: center">
                <strong style='font-size: 20px'>Recieved Responses</strong>
                    ...
                    <div class="col-md-10">
                        <table class="table table-hover" style="text-align: left">
                            ...
                            <?php
                                ...
                                for($i=0; $i<$mailbox->getResponsesSize();$i++){
                                
                                    $cr = $mailbox->getResponse($i);
                                    
                                    echo "<tr class='item ".$cr->getType()."' id='".$cr->getID()."' data-href='Complaint.php?thing=".$cr->getID()."&From=res'>";
                                    echo "<td>".$cr->getID()."</td>";
